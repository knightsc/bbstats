...
class Game(object):
    def __init__(self, game_id, gamecode):
        ...
        self.__boxscore_xml_url = 'http://www.nba.com/games/game_component/dynamic/%s/boxscore.xml' % (gamecode)        
        ...
        self.__playbyplay_xml_url = 'http://www.nba.com/games/game_component/dynamic/%s/pbp_all.xml' % (gamecode)
        self.__playbyplay_json_url = 'http://stats.nba.com/stats/playbyplay?GameID=%s&StartPeriod=0&EndPeriod=0' % (game_id)
        self.__shotchart_xml_url = 'http://www.nba.com/games/game_component/dynamic/%s/shotchart_all.xml' % (gamecode)        
